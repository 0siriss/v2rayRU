...
object AppConfig {
    ...
    const val PREF_SOCKS_SESSION_USERNAME = "pref_socks_session_username"
    const val PREF_SOCKS_SESSION_PASSWORD = "pref_socks_session_password"
    const val PREF_SOCKS_SESSION_PORT = "pref_socks_session_port"
